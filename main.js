...
//---------- THEATER ----------
theaterBtn.addEventListener("click", toggeTheaterMode)
function toggeTheaterMode(){
    videoContainer.classList.toggle('theater')
}
//---------- THEATER ----------

//---------- FULLSCREEN ----------
fullscreenBtn.addEventListener("click", toggeFullscreenMode)
function toggeFullscreenMode(){
...
//---------- MINI PLAYER VIDEO ----------
miniPlayerBtn.addEventListener("click", toggeMiniPlayerMode)
function toggeMiniPlayerMode(){
